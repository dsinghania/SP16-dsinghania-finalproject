$(document).ready(function(){
    ...
    var page = "http://api.bestbuy.com/v1/categories(id=pcmcat209400050001|id=abcat0501000|id=abcat0401000"+
    ...
    var page2 = page + "&page=2&format=json";    
     ...
     if(url !== "http://parkland-csc175.github.io/csc175data/bestbuy/categories-list.json")
        addData(newUrl);
    ...
    function getUrl(page){
        ...
        if(api !== "null")
            ...
            return "http://parkland-csc175.github.io/csc175data/bestbuy/categories-list.json";
    }
